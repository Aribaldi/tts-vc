...
sample = clear.sample(20)
sents = sample['sentence'].to_list()
with open('/run/media/iref/Seagate Expansion Drive/correctness_tests/text2.txt', 'w') as f:
    for s in sents:
        f.write(s.strip())
        f.write('\n')
