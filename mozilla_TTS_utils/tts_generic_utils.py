...
from mozilla_TTS_utils.generic_utils import check_argument
...
def setup_model(num_chars, num_speakers, c, speaker_embedding_dim=None):
    ...
    MyModel = importlib.import_module('mozilla_TTS_utils.models.' + c.model.lower())
...
def check_config_tts(c):
    ...
    from mozilla_TTS_utils.text import cleaners
