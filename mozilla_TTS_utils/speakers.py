...
def parse_speakers(c, args, meta_data_train, OUT_PATH):
    ...
    if c.use_speaker_embedding:
        ...
        if args.restore_path:
            ...
            raise Exception("use_external_speaker_embedding_file is True, so you need pass a external speaker embedding file, run GE2E-Speaker_Encoder-ExtractSpeakerEmbeddings-by-sample.ipynb or AngularPrototypical-Speaker_Encoder-ExtractSpeakerEmbeddings-by-sample.ipynb notebook in notebooks/ folder")
